...
/// <summary>
/// Class of trigger event for pull request event
/// </summary>
public class PullRequestTriggerEvent : TriggerEvent
{
    /// <summary>
    ...
    /// </summary>
    /// <value></value>
    public string[]? Types { get; set; } = new string[] { "opened", "synchronize", "reopened" };
}
